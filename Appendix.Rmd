...
#load data
GPS_df <- readRDS("data/GPS_df.rds")
bio_df <- readRDS("data/bio_df.rds")
DATA_TELEMETRY <- readRDS("data/DATA_TELEMETRY.rds")
...
#load encounter data
encounter_radius_df <- readRDS("rds/encounter_radius_df.rds")
#load pair data
...
#subset to range-resident individuals
GPS_df <- DATA_GPS[which(DATA_GPS$ID %in% 
...
#save GPS dataframe
saveRDS(GPS_df, file = "data/GPS_df.rds")
#save biological information dataframe
saveRDS(bio_df, file = "data/bio_df.rds")
...
for (i in 1:length(AKDE)) {
  #extract the home range area statistics from summary
...
```{r eval=FALSE, echo=FALSE}
#save AKDE home range estimations for each sex
...
```{r eval=FALSE, echo=FALSE}
ggsave(figure3c_encounters_overtime,
